  ...
  <div class="group relative rounded-xl shadow-md hover:drop-shadow-lg">
    ...
    <div
      ...
      <div class="mt-4 flex items-center justify-between gap-2">
        ...
        <button type="button" @click="downloadImage(_id, url)" class="border-none bg-transparent outline-none">
          <img :src="download" alt="download" class="object-contain h-6 w-6 invert" />
        </button>
      </div>
    </div>
  </div>
