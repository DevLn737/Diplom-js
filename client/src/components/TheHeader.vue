    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      <div class="w-full flex flex-wrap items-center justify-between mx-auto px-4 py-4">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse gap-2 items-center">
          ...
          <!--            <button-->
          <!--                type="button"-->
          <!--                class="focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">-->
          <!--              Регистрация-->
          <!--            </button>-->
          <!--          </RouterLink>-->
